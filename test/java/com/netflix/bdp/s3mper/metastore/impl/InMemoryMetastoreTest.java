...
/*  @Test
  ...
  public void testWritePerformace() throws Throwable {
    ...
    List<ConsistentListingAspectTest.FileCreator> writeThreads = new ArrayList<ConsistentListingAspectTest.FileCreator>();

    for (int i = 0; i < threadCount; i++) {
      ConsistentListingAspectTest.FileCreator f = new ConsistentListingAspectTest.FileCreator(deleteFs, fileCount, i);
      f.start();
    ...
    for(ConsistentListingAspectTest.FileCreator t : writeThreads) {
      t.join();
    }
